...
![Step 1 — Member Profile](img/mm-03-member-profile.png)

### Step 2 — Reset Password

Pick Email link, SMS temp password, or Generate Temporary Password. Add a ticket number in Admin Comment, then Reset.

![Step 2 — Reset Password](img/mm-04-reset-password-modal.png)

### Step 3 — Block Member

Stops the member from transacting but keeps their enrollment. Admin Comment is required.

![Step 3 — Block Member](img/mm-05-block-member-modal.png)

### Step 4 — Lock Member

Fast login freeze during a fraud call. Reversible from Manage Members > Locked Members.

![Step 4 — Lock Member](img/mm-06-lock-member-modal.png)

### Step 5 — Unenroll Member

Removes the digital profile completely. Use at account closure.

![Step 5 — Unenroll Member](img/mm-07-unenroll-modal.png)

### Step 6 — Manage Channels

Toggle Online / Mobile / Voice. Current state is pre-ticked — untick what you want to disable.

![Step 6 — Manage Channels](img/mm-08-manage-channels-modal.png)

### Step 7 — Sync Contact Details

Pulls fresh phone/email from the core when branch updates haven't flowed to digital.

![Step 7 — Sync Contact Details](img/mm-10-sync-contact-modal.png)

### Step 8 — Update Info New

Side-by-side Bank Core vs nFinia compare. Tick only the rows you want to push.

![Step 8 — Update Info New](img/mm-09-update-info-modal.png)

## Summary

Seven buttons at the top of every member profile. Each opens a modal (no silent commits) and captures an Admin Comment so the action shows up on Support History. Reset is for login recovery, Block and Lock are safeguards, Unenroll is for closure, Manage Channels toggles access, Sync and Update Info New fix stale contact data.
