...
Search is the way into Manage Members. Every admin action — Reset, Lock, Unenroll — runs from a member's profile, so you search first. Nine filters are available; User ID is fastest, Member Name is the fallback.
