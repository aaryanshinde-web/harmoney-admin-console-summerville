...
Dual-pane Available / Included scoped to one role. Enable only what the role needs; leave the rest on the left.
...
Each amount carries a frequency — Max Per Transaction, Max Daily, Max Monthly. Stack all three for layered defence.

![Step 4 — Limit Frequency](img/mb-13-role-limits-frequency.png)

### Step 5 — Role Information

Role name and one-line description — "Payroll — handles payroll", "AP Clerk — vendor ACH only". Read by audit six months later.
