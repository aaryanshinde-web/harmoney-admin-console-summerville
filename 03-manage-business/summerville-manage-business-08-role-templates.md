...
![Step 1 — Template Roles](img/mb-32-template-roles-list.png)

### Step 2 — Create New Template Role

Two-step form: Role Information (name + description), then feature set. Keep the name plain — admins will see it in their User Roles panel.

![Step 2 — Create New Template Role](img/mb-33-create-template-role.png)

### Step 3 — Template Role Permissions

Read-only list of features the role grants on day one — Bill Pay, Scheduled Transfer History, Recipients, External Transfers.

![Step 3 — Template Role Permissions](img/mb-34-template-role-permissions.png)

### Step 4 — Edit Template Role

Dual-pane Available / Included editor. Every downstream business that picks this role inherits the edit — treat it as a policy change.

![Step 4 — Edit Template Role](img/mb-35-template-role-permissions-edit.png)
