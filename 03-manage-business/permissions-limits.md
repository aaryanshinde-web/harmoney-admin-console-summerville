...
![Step 1: Business Permissions](img/mb-06-business-permissions-view.png)

### Step 2: Edit Business Permissions

Two panes: Available (left) and Included (right). Move features across to match the signed pricing schedule.
...
![Step 3: Business Limits](img/mb-08-business-limits-view.png)

### Step 4: Edit Business Limits

Three inputs per feature: Max Per Transaction, Max Daily, Max Monthly.

![Step 4: Edit Business Limits](img/mb-09-business-limits-edit.png)

## Summary

Two linked pages: Permissions = what capabilities the business has, Limits = the dollar ceiling on each. Both are entity-level and cap every user in the business.
