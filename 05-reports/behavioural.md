...
Logins vs failed-login percentage. Labelled Pacific Standard Time.

![Step 3: Login Trend](img/rp-03a-login-trend-default.jpg)

### Step 4: Enrollment Trend

New enrolments and unenrolments. Yellow No detailed data to show banner appears on quiet days.

![Step 4: Enrollment Trend](img/rp-04a-enrollment-trend-default.jpg)

### Step 5: Custom Duration

Four tabs: Last 7 Days, 30, 90, Custom. Custom exposes Select Start Date, Select End Date, Go.

![Step 5: Custom Duration](img/rp-04d-enrollment-trend-custom.jpg)

### Step 6: Feedback Report

In-app satisfaction rollups by window.
