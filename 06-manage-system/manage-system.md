...
Default = System Wide, One time, on, Pre-Outage Reminders on, Email delivery.

![Step 2: Add Outage](img/ms-02-add-outage.jpg)

### Step 3: Schedule Outage - Immediate

Toggle to Immediate. Date & Time collapses to a single To field.

![Step 3: Schedule Outage - Immediate](img/ms-03-add-outage-immediate.jpg)

### Step 4: Outage Type - Channel Specific

Channel radio: Online / Mobile / Voice, with a NOTE: All Modules marker.

![Step 4: Outage Type - Channel Specific](img/ms-04-add-outage-channel-specific.jpg)

### Step 5: Outage Type - Module Specific

Module Type dropdown (Pay Bills, Wire, ACH), plus icon to add siblings, Online / Mobile / Voice checkboxes.
...
Platform + Type of upgrade = Recommended. Start Date and End Date pickers appear.
...
Toggle Mandated. Dates disappear: hard cut-off on publish.

![Step 8: Add Deprecation Notification - Mandated](img/ms-08-app-deprecation-mandated.jpg)

## Summary

Two surfaces: System Outages for planned and live-incident outages, App Deprecation for mobile-build lifecycle.
...
- Live incident: Immediate, System Wide, publish.
